    var lamdas = {}; 
    //structure: { "id_Vertex1": valeur_lamda1, "id_Vertex2": valeur_lamda2, ... } 
    //OBJET LISTE contenant l' id d'un sommet(Vertex) et son valeur lamda associatif

    var parents = {};
    //structure: {"id_vertex1": id_Vertex_Anterieur_1 ,"id_vertex2": id_Vertex_Anterieur_1, ... }
    //OBJET LISTE contenant l' id d'un sommet(Vertex) et l'id du sommet qui lui precede (son sommet anterieur)
    //exemple: {source.id : null} car le source n'a pas de sommet anterieur, il est le debut du graphe
